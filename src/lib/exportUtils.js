...
export const generateInventoryStockPDF = (items = [], clinicName = '') => {
    ...
    doc.setTextColor(90);
    if (clinicName) doc.text(clinicName, 14, 28);
    doc.text(`Dicetak: ${generatedAt}`, 14, clinicName ? 34 : 28);
    ...
    autoTable(doc, {
        startY: clinicName ? 42 : 36,
        head: [['No', 'Nama Barang', 'Status', 'Stok', 'Satuan', 'Harga/Satuan', 'Nilai Stok']],
        body: rows,
        theme: 'grid',
        headStyles: { fillColor: [30, 58, 95], fontSize: 11, fontStyle: 'bold' },
