...
export const OWNER_NAV_ITEMS = [
  ...
  { label: 'Presentasi Direksi', path: '/owner/presentation', icon: 'MonitorPlay' },
  {
    ...
    submenu: [
      ...
      { label: 'Follow Up Management', path: '/owner/follow-up-management' },
  ...
  { label: 'Package Recaps', path: '/owner/package-recaps', icon: 'Package' },
  {
    ...
    icon: 'Users',
    submenu: [
      { label: 'Physiotherapist Management', path: '/owner/physiotherapist-management' },
      { label: 'Admin Management', path: '/owner/admin-management' },
      { label: 'Absensi Karyawan', path: '/owner/attendance' },
    ],
  },
...
export const ADMIN_NAV_ITEMS = [
  ...
  { label: 'Feedback Pasien', path: '/admin/feedback', icon: 'Star' },
