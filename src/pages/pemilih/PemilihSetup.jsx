...
import { MapPin, Tag, ListChecks, UserPlus, ShieldCheck } from 'lucide-react';
...
import PemilihDpcAkun from './PemilihDpcAkun';
...
const TABS = [
  ...
  { key: 'dpc', label: 'Akun DPC', icon: ShieldCheck },
];
