      ...
      return (
          <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center p-4 sm:p-6">
              ...
              >
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-[#1e3a8a] mb-2 tracking-tight">Booking Berhasil!</h2>
                  <p className="text-slate-500 mb-8 leading-relaxed">Terima kasih telah melakukan booking. Admin kami akan segera menghubungi Anda via WhatsApp untuk konfirmasi jadwal.</p>
