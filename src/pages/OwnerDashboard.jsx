        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-[#F5F9FC] to-[#EAF4FF] text-[#102F52] p-5 md:p-7 shadow-sm border border-[#DCE8F2]">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-xl md:text-2xl font-bold tracking-tight text-[#102F52]">Owner Dashboard</h1>
              <p className="text-[#5B6B7D] text-xs mt-1">Executive overview of clinic performance.</p>
            </div>
