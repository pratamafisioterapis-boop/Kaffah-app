...
// ── Revenue per Terapis ──
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      {/* ── Executive Hero: Financial Health Overview ── */}
      <Card className="overflow-hidden border-0 rounded-3xl bg-white shadow-lg shadow-slate-200/70 relative">
        {/* Decorative soft-blue glows */}
        ...
        <CardContent className="p-6 md:p-8 pb-0 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5 mb-6">
            <div className="flex items-start gap-4 min-w-0">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-100 to-sky-50 flex items-center justify-center shrink-0">
                <BarChart3 className="w-7 h-7 text-blue-600" />
              </div>
              <div className="min-w-0">
                <p className="text-slate-400 text-[11px] font-bold uppercase tracking-widest mb-1.5">Financial Health Overview</p>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#0b1f4b] leading-tight">
                ...
                <p className="text-slate-400 text-xs mt-2 leading-relaxed">
                  ...
                  <br className="sm:hidden" /> <span className="text-slate-400">(sama seperti Break Even Point)</span>
                </p>
              </div>
            </div>

            <div className="flex flex-col items-start sm:items-end gap-2 shrink-0">
              <div className={`px-4 py-2 rounded-full text-xs font-bold flex items-center gap-1.5 whitespace-nowrap ${
                metrics.netProfit >= 0
          ...
          <div className="space-y-3">
            <div className="rounded-2xl p-4 md:p-5 bg-gradient-to-r from-emerald-50 to-teal-50/60">
            ...
            <div className="rounded-2xl p-4 md:p-5 bg-gradient-to-r from-amber-50 to-orange-50/60">
              <div className="flex items-center gap-3 mb-3">
        ...
        <div className="relative mt-6 pt-8 md:pt-10 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-end justify-between px-6 md:px-8 pb-3 md:pb-4">
            <p className="text-[10px] md:text-[11px] text-[#0b1f4b]/70 font-semibold leading-tight">
