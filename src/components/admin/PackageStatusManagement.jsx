...
import EditPackageStatusModal from './EditPackageStatusModal';

const PackageStatusManagement = () => {
  ...
  const handleBulkStatusUpdate = async () => {
    if (!selectedIds.length || !bulkStatusValue) return;
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `Updated status for ${selectedIds.length} package(s).`
      });
      fetchData();
...
export default PackageStatusManagement;