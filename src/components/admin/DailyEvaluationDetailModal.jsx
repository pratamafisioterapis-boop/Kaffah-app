...
import { User, Calendar, ClipboardList, Clock, FileText } from 'lucide-react';
import { Badge } from '@/components/ui/badge';

const DailyEvaluationDetailModal = ({ isOpen, onClose, patientData }) => {
            ...
            {sortedRecords.length === 0 ? (
                ...
                <div key={record.id} className="relative pl-8 pb-2 last:pb-0">
                    ...
                    <div className="bg-slate-50/50 px-5 py-3 border-b border-slate-100 flex flex-wrap gap-y-2 justify-between items-center">
                        ...
                        {record.therapist?.full_name || record.therapist_name || 'Terapis Tidak Diketahui'}
                        </div>
                    </div>
...
export default DailyEvaluationDetailModal;