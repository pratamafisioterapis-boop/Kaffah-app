...
// hanya dipisah namespace localStorage-nya supaya sesi verifikasi Payroll dan
// MOU tidak saling bocor satu sama lain.
const SESSION_TTL_MS = 5 * 60 * 1000;
const RESEND_COOLDOWN_S = 60;

const sessionKey = (therapistId) => `kaffah_mou_otp_verified_${therapistId}`;
const lastSentKey = (therapistId) => `kaffah_mou_otp_last_sent_${therapistId}`;
...
const MouAuthGate = ({ therapist, children }) => {
  ...
  const handleVerify = async () => {
    ...
    setVerified(true);
    toast({ title: 'Terverifikasi', description: 'Dokumen MOU Anda sudah bisa diakses.' });
  };
